        ...
        <div className="min-h-screen bg-slate-950 text-slate-100">
            ...
            <div className="flex w-full flex-col pt-16 md:flex-row md:items-stretch">
                <aside
                    ...
                    aria-label="Wallet and customers navigation"
                >
                ...
                <div className="sticky top-16 z-20 flex gap-2 border-b border-white/10 bg-slate-950/95 px-3 py-2 backdrop-blur-md md:hidden">
                    <NavLink
                        to="/premium-entry"
                        end
                        className={({ isActive }) =>
                            [
                                "flex flex-1 items-center justify-center gap-2 rounded-xl py-2.5 text-xs font-semibold transition-colors",
